...
class PrintingQueue extends Page
{
    protected string $view = 'filament.pages.printing-queue';
    protected static ?string $navigationLabel = 'Printing Queue';
    protected static ?string $title = 'Printing Queue';
